...
// shader. Solution: /src/1.getting_started/4.3.textures_exercise1/
...
int main()
{
    std::cout << "Started ex 7.8.1" << std::endl;
    ...
    Shader ourShader("src/shaders/tex/vertex.vert", "src/shaders/tex/flipped.frag");
